...
public class SortAscendingAction extends SortAction {
	 ...
	 */
	private static final String TRANSLATION_KEY = "Ascending";
	/**
	 * Key at which this action's description is stored.
	 */
	private static final String DESCRIPTION_KEY = "Ascending_desc";
	/**
	 * Keyboard shortcut.
	 */
	private static final String ACCELERATOR_KEY_VALUE = "control G";
	/**
	 * Displayed shortcut.
	 */
	private static final int MNEMONIC_KEY_VALUE = KeyEvent.VK_G;
	/**
	 * This action's icon name.
	 */
	private static final String ICON_NAME = "ascending";
	/**
	 * Constructor.
	 ...
	 */
	public SortAscendingAction( MultipleDocumentModel mdm, ILocalizationProvider flp) {
	...
	protected void sort(List<String> selectedLines) {
		...
		selectedLines.sort( Collator.getInstance( locale));
	}
}
